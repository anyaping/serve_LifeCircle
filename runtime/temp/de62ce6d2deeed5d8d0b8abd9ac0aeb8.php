<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"E:\tp5.0\public/../application/admin\view\carousel\edit.html";i:1510323456;}*/ ?>
...
<div class="container kv-main">
    ...
    <form enctype="multipart/form-data">
        <div class="form-group">
            ...
            <br>
            <input type="hidden" id="carousel_id" value="<?php echo $results['id']; ?>">
            ...
            <br><br>
                <select type="text" class="form-control" id="column">
                    <?php if(is_array($columns) || $columns instanceof \think\Collection || $columns instanceof \think\Paginator): $i = 0; $__LIST__ = $columns;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo $vo['id']; ?>" <?php if($results['carousel_columnid'] == $vo['id']): ?> selected<?php endif; ?>><?php echo $vo['column_name']; ?></option>
