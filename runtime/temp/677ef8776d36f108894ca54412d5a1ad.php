<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"E:\tp5.0\public/../application/admin\view\note\index.html";i:1510302658;}*/ ?>
        ...
        <tbody>
                <?php if(is_array($results) || $results instanceof \think\Collection || $results instanceof \think\Paginator): $i = 0; $__LIST__ = $results;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr class="active">
                        ...
                        <td><?php if($vo['note_status'] == '1'): ?>已发布<?php else: ?>待发布<?php endif; ?></td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-danger release" value="<?php echo $vo['id']; ?>">发布</button>
