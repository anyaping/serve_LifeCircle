<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"D:\tp5.0\public/../application/admin\view\index\index.html";i:1510319794;s:58:"D:\tp5.0\public/../application/admin\view\common\head.html";i:1510022032;s:58:"D:\tp5.0\public/../application/admin\view\common\menu.html";i:1510539935;}*/ ?>
<!Doctype html>
<html>
<head>
    <meta charset="utf-8">
	...
	<ol>
		<li class="ol_li">栏目管理</li>
			<ul>
				...
				<li class="test" id="/admin/twocolumn/index" onclick="loadUrl(this.id)">二级栏目</li>
			</ul>
		...
		<li class="ol_li">反馈管理</li>
			<ul>
				<li class="test" id="/admin/back/index" onclick="loadUrl(this.id)">用户反馈列表</li>
			</ul>
	</ol>
</div>
