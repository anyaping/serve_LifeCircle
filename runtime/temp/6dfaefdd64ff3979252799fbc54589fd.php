<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"E:\tp5.0\public/../application/admin\view\index\text.html";i:1510067100;}*/ ?>
        ...
        <tbody>
                <?php if(is_array($results) || $results instanceof \think\Collection || $results instanceof \think\Paginator): $i = 0; $__LIST__ = $results;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr class="active">
                        ...
                        <td><img width="50px" src= "__LOGO__<?php echo $vo['column_logo']; ?>"></td>
    ...
    $(function(){
        ...
        $('.del').click(function(){
            var id = $(this).val(); 
            $.ajax({
                url: "<?php echo url('index/del'); ?>",    //请求地址
                data:{
                    id:id
                },
                type:"get",
